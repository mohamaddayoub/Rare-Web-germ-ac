...
<head>
    ...
    {{-- No Sections Css File Because I Used Tailwind Css --}}
...
<body>
    ...
    <div class="my-container bg-king text-white">
        <h1
            ...
            {{ __('translate.sections-head') }}</h1>
        <p class="text-lg md:text-xl text-center mb-5 md:mb-10">
            {{ __('translate.sections-text') }}
        </p>
